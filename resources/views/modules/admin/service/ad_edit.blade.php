        ...
        <div class="modal fade bs-qrcode-modal-sm" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel">
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    ...
                    <img class="img-rounded center-block" id='qrcode' src="{{ $ad->qrcode }}" style="width: 200px;height: 200px;">
                </div>
            </div>
        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-12 col-xs-12">
                                    ...
                                    <div class="form-group">
                                        <label>模板名称</label>
                                        <input type="text" name="name" class="form-control"  placeholder="请输入模板名称" value="{{ $ad->name }}">
                                    </div>
                                    <div class="form-group">
                                        <label>分享来源</label>
                                        <input type="text" name="share" class="form-control"  placeholder="请输入分享推荐来源" value="{{ $ad->share }}">
                                    </div>
                                    <div class="form-group">
                                        <label>广告图标 <small>（ 重新上传后，将替换原图 ）</small></label>
                                        <input type="file" name="litimg"  class="projectfile"  multiple="multiple">
                                        <p class="help-block">请上传大小在2M以内的图片</p>
                                    </div>
                                    <div class="form-group">
                                        <label>主体名称</label>
                                        <input type="text" name="title" class="form-control" placeholder="请输入公司主体名称" value="{{ $ad->title }}">
                                    </div>
                                    <div class="form-group">
                                        <label>主体标签</label>
                                        <input type="text" name="label" class="form-control"  placeholder="请输入主体标签" value="{{ $ad->label }}">
                                    </div>
                                    <div class="form-group">
                                        <label>联系电话</label>
                                        <input type="text" name="mobile" class="form-control"  placeholder="请输入主体标签" value="{{ $ad->mobile }}">
                                    </div>
                                    <div class="form-group">
                                        <label>微信二维码 <small>（ 可以是个人或公众号的二维码， 重新上传后，将替换原图）</small></label>
                                        <input type="file" name="qrcode"  class="projectfile"  multiple="multiple">
                                        <p class="help-block">请上传大小在2M以内的图片</p>
                                    </div>
                                    <div class="form-group">
                                        <label>在线咨询连接</label>
                                        <input type="text" name="chat_url" class="form-control"  placeholder="请输入小标题一" value="{{ $ad->chat_url }}">
                                    </div>
                                    <div class="form-group">
                                        <label>标题一</label>
                                        <input type="text" name="one_t" class="form-control"  placeholder="请输入小标题一" value="{{ $ad->one_t }}">
                                    </div>
                                    <div class="form-group">
                                        <label>标题一内容</label>
                                        <input type="text" name="one_d"  class="form-control"  placeholder="请输入小一内容" value="{{ $ad->one_d }}">
                                    </div>
                                    <div class="form-group">
                                        <label>标题一内容链接 <small>（ 选填 ）</small></label>
                                        <input type="text" name="one_d_url"  class="form-control"  placeholder="请输入小一内容" value="{{ $ad->one_d_url }}">
                                    </div>
                                    <div class="form-group">
                                        <label>标题二</label>
                                        <input type="text" name="two_t" class="form-control"  placeholder="请输入小标题二" value="{{ $ad->two_t }}">
                                    </div>
                                    <div class="form-group">
                                        <label>标题二内容</label>
                                        <input type="text" name="two_d"  class="form-control"  placeholder="请输入小二内容" value="{{ $ad->two_d }}">
                                    </div>
                                    <div class="form-group">
                                        <label>标题二内容链接 <small>（ 选填 ）</small></label>
                                        <input type="text" name="two_d_url"  class="form-control"  placeholder="请输入小一内容" value="{{ $ad->two_url }}">
                                    </div>
                                    <div class="form-group">
                                        <label>标题三</label>
                                        <input type="text" name="three_t" class="form-control"  placeholder="请输入小标题三" value="{{ $ad->three_t }}">
                                    </div>
                                    <div class="form-group">
                                        <label>标题三内容</label>
                                        <input type="text" name="three_d"  class="form-control"  placeholder="请输入小三内容" value="{{ $ad->three_d }}">
                                    </div>
                                    <div class="form-group">
                                        <label>标题三内容链接 <small>（ 选填 ）</small></label>
                                        <input type="text" name="three_d_url"  class="form-control"  placeholder="请输入小一内容" value="{{ $ad->three_d_url }}">
                                    </div>
                                    ...
                                    <div style="background-color: #F4F5F5;border: 1px solid #9FA0A2">
                                        ...
                                        <div style="padding:10px">
                                            <div style="background-color:#FFFFFF;padding: 10px 10px 0px 10px; ">
                                                <img src="{{ $ad->litimg }}" class="img-circle center-block" style="width: 40px;height: 40px;">
...
@section('afterScript')
    ...
    <script type="text/javascript" src="{{ URL::asset('assets/js/admin/service/ad_edit.js') }}"></script>
@endsection