...
class SpreadPeopleModel extends Model
{
    ...
    protected $fillable   = ['name','openid','tasks_id','upper','source','level','level_num','people_ids',
        'people_num','read_num','read_at','read_time','sex','province','city','wechat','wechat_group','timeline','qq','qzone'];
